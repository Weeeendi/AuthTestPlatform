...
# Form implementation generated from reading ui file 'd:\workspace\python\Fluent\PyQt-Fluent-Widgets\examples\window\clock\resource\ui\FocusInterface.ui'
#
...
class Ui_FocusInterface(object):
    def setupUi(self, FocusInterface):
        ...
        self.progressRing.setMaximumSize(QtCore.QSize(240, 240))
        font = QtGui.QFont()
        ...
        self.taskCard.setMaximumSize(QtCore.QSize(16777215, 395))
        ...
        self.gridLayout.addWidget(self.taskCard, 1, 0, 1, 2)
